    ...
    <main className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <section className="py-32 px-8 relative">
        <div className="max-w-7xl mx-auto">
          {/* Section Number */}
          <div className="absolute top-8 right-8 text-xs tracking-[0.4em] uppercase opacity-40">01 / SKILLS</div>
          ...
          <div className="grid grid-cols-12 gap-16 items-start">
            ...
            >
              <h3 className="text-2xl font-light tracking-[0.1em] uppercase mb-16 opacity-60">Development Stack</h3>
            ...
            >
              <h3 className="text-2xl font-light tracking-[0.1em] uppercase mb-16 opacity-60">Creative Tools</h3>
      ...
      <section className="py-32 px-8 relative border-t border-white/10">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-12 gap-8 items-center">
            ...
            >
              <h2 className="text-[clamp(3rem,8vw,8rem)] font-light tracking-[-0.05em] leading-[0.8]">
                LET&apos;S
                <br />
            ...
            >
              <div className="group cursor-pointer">
                <div className="w-32 h-32 border border-white/30 rounded-full flex items-center justify-center group-hover:bg-white group-hover:text-black transition-all duration-500">
                  <span className="text-xs tracking-[0.3em] uppercase font-light">CONTACT</span>
                </div>
              </div>
            </motion.div>
          </div>
