...
const Profile = () => {
  const mainTechnologies = [
    'React', 'Next.js', 'TypeScript', 'TailwindCSS', 'React Native', 'Python', 'Java'
  ];
          ...
          <div className="max-w-6xl mx-auto w-full">
            ...
            >
              <p className="text-[10px] tracking-[0.4em] uppercase text-white/60 font-light">
                Photo and Video Editor / Frontend / UI/UX
              </p>
      ...
      <section className="py-32 px-8 bg-black text-white">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            Combining my skills for code with videography and design, I create engaging 
