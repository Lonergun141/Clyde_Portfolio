          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8">
            ...
            >
              <div className="space-y-8">
                <div>
                  <p className="text-sm uppercase tracking-[0.2em] text-primary-foreground mb-6">Get in Touch</p>
                  <motion.a
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <p className="text-sm uppercase tracking-[0.2em] text-muted-foreground mb-4">Location</p>
                    <p className="text-xl font-light">{contactDetails[1].value}</p>
                  </div>
                  <div>
                    <p className="text-sm uppercase tracking-[0.2em] text-muted-foreground mb-4">Phone</p>
            ...
            {/* Education & Social - Smaller Columns */}
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-16">
              ...
              >
                ...
                {education.map((edu, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="space-y-3 pb-6 border-b border-border/20 last:border-b-0"
                  >
              ...
              <motion.div
                ...
                className="space-y-8"
              >
                <p className="text-sm uppercase tracking-[0.2em] text-muted-foreground">Follow</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-8">
              <p className="text-sm font-mono tracking-wide">© {new Date().getFullYear()} Clyde Gevero</p>
              <p className="text-sm text-muted-foreground font-mono">Built with Next.js & TailwindCSS</p>
            </div>
            <motion.div whileHover={{ scale: 1.05 }} className="text-sm font-mono tracking-wide text-primary">
